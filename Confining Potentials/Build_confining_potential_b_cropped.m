function [Mat_V_a, Mat_V_b]=Build_confining_potential_b_cropped(r_Border,disp_x,disp_y,N_horiz_points,N_verti_points,vec_x,vec_y,V_0,Pinning_flag,V_pinning,sigma_pinning)
...
if Pinning_flag==0
    ...
    for i=1:N_verti_points
        for j=1:N_horiz_points
            if (vec_x(j))^2+(vec_y(i))^2<(coeff_crop_b*r_Border)^2
                Mat_V_b(i,j)=0;
            else
                Mat_V_b(i,j)=V_0;
            end
